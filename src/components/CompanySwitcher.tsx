                ...
                <div className="flex items-center gap-2.5 overflow-hidden">
                    <div className={cn(
                        ...
                        {activeMembership?.companyLogo ? (
                            ...
                            <img src="/images/ops-logo.png" alt="Agents OPS" className={cn("object-contain", compact ? "h-4 w-4" : "h-6 w-6")} />
                        )}
                    </div>
                                         ...
                                         <div className="flex items-center gap-3 min-w-0 flex-1 pr-4">
                                             <div className={cn(
                                                 ...
                                                 {membership.companyLogo ? (
                                                     ...
                                                     <img src="/images/ops-logo.png" alt="Agents OPS" className="h-5 w-5 object-contain opacity-50 group-hover:opacity-80 transition-opacity" />
                                                 )}
                                             </div>
